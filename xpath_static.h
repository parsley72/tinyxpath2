...
extern const tinyxml2::XMLNode* XNp_xpath_node(const tinyxml2::XMLNode* XNp_source_tree, const char* cp_xpath_expr);
extern const tinyxml2::XMLAttribute* XAp_xpath_attribute(
