...
class xpath_processor : public xpath_stream {
   ...
   protected:
    ...
    void v_push_string(TIXML_STRING S_val) {
        xs_stack.v_push_string(S_val);
    }
    void v_push_bool(bool o_val) {
        xs_stack.v_push_bool(o_val);
    }
    void v_push_double(double d_val) {
        xs_stack.v_push_double(d_val);
    }
    void v_push_node_set(node_set* nsp_val) {
        xs_stack.v_push_node_set(nsp_val);
    }

    bool o_pop_bool() {
        return xs_stack.o_pop_bool();
    }
    int i_pop_int() {
        return xs_stack.i_pop_int();
    }
    TIXML_STRING S_pop_string() {
        return xs_stack.S_pop_string();
    }
    node_set ns_pop_node_set() {
        return xs_stack.ns_pop_node_set();
    }
